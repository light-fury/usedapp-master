...
export function useContractFunction(contract, functionName, options) {
    ...
    const send = useCallback(async (...args) => {
        ...
        if (contract) {
            ...
            const gasLimit = (_a = (await estimateContractFunctionGasLimit(contractWithSigner, functionName, args, gasLimitBufferPercentage))) !== null && _a !== void 0 ? _a : BigNumber.from(0);
