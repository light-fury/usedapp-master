...
function useContractFunction(contract, functionName, options) {
    ...
    const send = (0, react_1.useCallback)(async (...args) => {
        ...
        if (contract) {
            ...
            const gasLimit = (_a = (await (0, usePromiseTransaction_1.estimateContractFunctionGasLimit)(contractWithSigner, functionName, args, gasLimitBufferPercentage))) !== null && _a !== void 0 ? _a : ethers_1.BigNumber.from(0);
            const modifiedOpts = {
                gasLimit,
                ...opts,
            };
